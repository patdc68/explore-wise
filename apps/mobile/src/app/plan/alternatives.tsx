...
function AlternativeCard({ place, distanceOrigin, broader, selected, onSelect }: { place: PricedNearbyPlace; distanceOrigin: StageDistanceOrigin; broader: boolean; selected: boolean; onSelect: () => void }) {
